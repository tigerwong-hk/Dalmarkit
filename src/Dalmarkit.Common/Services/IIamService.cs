...
public interface IIamService
{
    ...
    Task<string?> AdminCreateUserAsync(string identityProviderId, string emailAddress, string phoneNumber, bool resendInvitationMessage = false, Dictionary<string, string>? clientMetadata = null);
    ...
    Task<string?> AdminResendInvitationMessageAsync(string identityProviderId, string emailAddress, string phoneNumber, Dictionary<string, string>? clientMetadata = null);
